# ----------------------------------------------------------------------------
#	test_leds_direct2.py
#
#	Copyright 2021 Daniel Tisza
#	MIT License
#
#	Test setting all LED sets lightings from A to H using Python serial
#
# ----------------------------------------------------------------------------
...
# self._port.write(self._cmd_hex(str(hex(hexa))))
# self._cmd_hex(str(hex(hexa)))
# self._cmd_hex = lambda a: str.encode(f'L{a}\r\n')
